                ...
                <div class="summary-card mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php foreach ($categories as $cat): ?>
                            <li class="mb-1">
                                <a href="product.php?category=<?php echo (int)$cat['id']; ?><?php echo $search_query ? '&search=' . urlencode($search_query) : ''; ?>"
...
?>
                ...
                <?php if (empty($products)): ?>
                    <div class="empty-state">
                        ...
                        <a href="product.php" class="btn btn-primary-ekea">View All Products</a>
                    </div>
                <?php
else: ?>
                    <div class="row g-4">
                        ...
                        <nav aria-label="Product pagination" class="mt-5">
                            <ul class="pagination justify-content-center">
                                <li class="page-item <?php echo $page <= 1 ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="<?php echo $base_url; ?>sort=<?php echo $sort_by; ?>&page=<?php echo $page - 1; ?>"
                                ...
                                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                    <li class="page-item <?php echo $i === $page ? 'active' : ''; ?>">
                                        <a class="page-link" href="<?php echo $base_url; ?>sort=<?php echo $sort_by; ?>&page=<?php echo $i; ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php
