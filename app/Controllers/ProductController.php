...
class ProductController extends BaseController {
    ...
    public function detail(Request $request, Response $response, array $args): Response {
        ...
        $csrf_token = generate_csrf_token();
        return $this->render($response, 'shop/product_detail', compact('product','reviews','avg_rating','has_reviewed','has_purchased','related_products','product_id','page_title','current_page','use_chartjs','csrf_token'));
    }
