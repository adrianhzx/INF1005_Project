        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 fade-in-up">
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div
                            style="background: var(--color-bg-alt); border-radius: var(--border-radius-lg); padding: 2rem;">
                    ...
                    <div class="col-12">
                        <div id="ekea-map"
                            style="height: 280px; border-radius: var(--border-radius-lg); overflow: hidden; border: 2px solid var(--color-border);">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 fade-in-up">
                <div class="value-card h-100">
                    ...
                    <p class="text-muted-ekea mb-0">We use responsibly sourced materials and eco-friendly manufacturing
                        processes to minimise our environmental impact.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 fade-in-up">
                <div class="value-card h-100">
                    ...
                    <p class="text-muted-ekea mb-0">Our in-house design team draws inspiration from Scandinavian
                        minimalism, creating pieces that are both beautiful and practical.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 fade-in-up">
                <div class="value-card h-100">
                    ...
                    <p class="text-muted-ekea mb-0">We believe in building lasting relationships with our customers and
