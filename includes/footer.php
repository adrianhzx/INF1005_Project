            ...
            <div class="row g-4 py-5">
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="footer-links list-unstyled">
                        <li><a href="<?php echo $base_path ?? ''; ?>product.php">All Products</a></li>
                        <li><a href="<?php echo $base_path ?? ''; ?>product.php?category=1">Living Room</a></li>
                        <li><a href="<?php echo $base_path ?? ''; ?>product.php?category=2">Bedroom</a></li>
                        <li><a href="<?php echo $base_path ?? ''; ?>product.php?category=3">Dining</a></li>
                        <li><a href="<?php echo $base_path ?? ''; ?>product.php?category=4">Office</a></li>
                    </ul>
                </div>
    ...
    (function() {
        ...
        function sendMessage() {
            ...
            fetch(basePath + 'chatbot.php', { method: 'POST', body: formData })
