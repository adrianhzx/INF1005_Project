...
<section class="section-padding">
    <div class="container">
        ...
        <form id="checkoutForm" method="POST" action="<?= BASE_URL ?>/checkout" class="ekea-form" novalidate>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    applyCouponBtn.addEventListener('click', function() {
        ...
        fetch('<?= BASE_URL ?>/checkout/coupon', { method: 'POST', body: formData })
            .then(function(r) { return r.json(); })
            .then(function(data) {
    ...
    checkoutForm.addEventListener('submit', function(e) {
        ...
        fetch('<?= BASE_URL ?>/checkout/stripe-intent', { method: 'POST', body: fd })
            .then(function(r) { return r.json(); })
            ...
            .then(function(result) {
                ...
                if (result.paymentIntent && result.paymentIntent.status === 'succeeded') {
                    // Step 3: Attach payment_intent_id and submit form
