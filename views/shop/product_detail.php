    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/products?category=<?php echo (int)$product['category_id']; ?>"><?php echo htmlspecialchars($product['category_name'], ENT_QUOTES, 'UTF-8'); ?></a></li>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="alert alert-info mb-4">
                ...
                <a href="<?= BASE_URL ?>/login" class="fw-semibold">Log in</a> to leave a review.
            </div>
        <?php endif; ?>
                ...
                <div class="col-lg-3 col-md-6 fade-in-up">
                    <div class="product-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= BASE_URL ?>/products/<?php echo (int)$rp['id']; ?>" class="text-decoration-none">
